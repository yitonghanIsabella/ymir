...
|部署相机|算法管理|公有算法|支持算法定制化、查看其他人上传的公有算法并部署到我的设备|
|部署相机|算法管理|算法中心|支持已部署算法的查看、开启、删除、抓拍设置|
|部署相机|相机管理|相机设置|支持对相机的基础信息和IP进行设置|
|部署相机|相机管理|抓拍查看|支持查看相机的所有抓拍|
